...
def enter(user, reply):
	...
	msg = (
		...
		'«Привит, юдишка! Йа есть Лука! Босс сказал Луке таргавать!! Лука типерь умеет в тарговлю!»\n\n'
		'Зуб (Цена 1 зуб)\n'
		'Тока што выбил с {0}, дажи кечтуп ищо капаит!\n\n'
		'Палка (Цена 5 зубов)\n'
		'Плахая палка, адной такой стукнул юдишку — а она сламалась\n\n'
		'Парашок (Цена 5 зубов)\n'
		'Вкусный парашок, клянусь Лупой и Пупой!'
	)
...
def action(user, reply, text):
	if text == 'Зуб':
		...
		if user.has_item('tooth'):
			...
			reply('«Нет зубов — нет товара» — хотел сказать орк, но просто ударил тебя по лицу хуем.')
