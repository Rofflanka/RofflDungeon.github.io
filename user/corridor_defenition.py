...
#		self.set_variable('halloween_visited', True)
		...
		reply('Поднимаясь выше по лестнице, ты заметил, что кто-то написал, какие монстры есть на этом этаже')
		...
		reply('Спускаясь, ты заметил, что кто-то написал, какие монстры есть на этом этаже')
